...
# into the appropriate folder and setting the include path for library-specific
# header files.
...
LOCAL_SRC_FILES := ImageTargets.cpp SampleAppRenderer.cpp SampleUtils.cpp Texture.cpp SampleMath.cpp
