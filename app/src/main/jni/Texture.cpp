...
Texture::create(JNIEnv* env, jobject textureObject)
{
    ...
    newTexture->mWidth = static_cast<unsigned int>(env->GetIntField(textureObject, widthID));
    ...
    newTexture->mHeight = static_cast<unsigned int>(env->GetIntField(textureObject, heightID));
