...
/**
 * VuforiaSampleGLView is a support class for the Vuforia samples applications.
 * 
 * Responsible for setting up and configuring the OpenGL surface view.
 * 
 * */
public class VuforiaSampleGLView extends GLSurfaceView
{
    private static final String LOGTAG = "VuforiaSampleGLView";
    /** Constructor. */
    public VuforiaSampleGLView(Context context)
    {
        super(context);
    }
